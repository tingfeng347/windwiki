...
![image-20251204144529594](/images/python-basics/image-20251204144529594.png)

### 1.1.2 软件

计算机软件主要分为：系统软件、应⽤软件。

![image-20251204144910447](/images/python-basics/image-20251204144910447.png)
...
![image-20251204145342959](/images/python-basics/image-20251204145342959.png)
...
![image-20251204145601988](/images/python-basics/image-20251204145601988.png)

![image-20260224110131240](/images/python-basics/image-20260224110131240.png)
...
![image-20251204151118032](/images/python-basics/image-20251204151118032.png)
...
![image-20251204151222235](/images/python-basics/image-20251204151222235.png)
...
![image-20251204160455002](/images/python-basics/image-20251204160455002.png)
...
- Python是一门“先（隐式）编译为字节码，再由虚拟机解释执行”的语言。它没有JIT编译步骤，其“编译”主要服务于语法分析和生成中间格式，而非性能优化。其核心执行模型仍然是解释型的。虽然它确实经历了“编译”和“解释”两个阶段，但我们通常**不称之为“混合型语言”**，因为它缺乏关键的 **运行时编译优化** 环节。
  ...
  ![image-20260224092846190](/images/python-basics/image-20260224092846190.png)
...
![image-20251204160830513](/images/python-basics/image-20251204160830513.png)

![image-20260224093050508](/images/python-basics/image-20260224093050508.png)
...
![image-20251204162247375](/images/python-basics/image-20251204162247375.png)

### 1.3.2 Python的特点

优点：

![image-20251204162345136](/images/python-basics/image-20251204162345136.png)

缺点：

![image-20251204162435270](/images/python-basics/image-20251204162435270.png)
